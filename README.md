...
### Dica rápida para o GitHub:
Ao colar isso no GitHub, clique na aba **"Preview"** antes de salvar (fazer o *commit*). Isso permite ver em tempo real se os selos coloridos e os blocos de código carregaram da forma como você imaginava. 

O layout ficou melhor e mais amigável agora?

``````markdown
<div align="center">
  <h1>🚚 Previsão de Custos de Frete (End-to-End)</h1>
  <p>Da coleta de dados ao deploy da API REST</p>
...
> *O R² de 0.52 é um baseline sólido, considerando a alta volatilidade e as diferentes políticas de preços das transportadoras no Brasil.*
...
**4. Teste no navegador (Swagger UI):**
Aceda a `http://127.0.0.1:8000/docs` e utilize o JSON abaixo no endpoint **POST** para testar a previsão:
...
<div align="center">
<h3>👨‍💻 Autor</h3>
<p><b>Desenvolvido por Jp.Mota</b></p>
<p>Acompanhe o meu portfólio para ver mais projetos onde a engenharia de software encontra a ciência de dados:</p>
<a href="https://dspedroportfolio.vercel.app/">🌐 Aceder ao Portfólio</a>
</div>
